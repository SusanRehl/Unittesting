...
//  it('has a dummy spec to test 2 + 2', function() {
    ...
    // expect().toEqual(4);   toEqual(4) is the chained matcher function, 4 is the actual.This is the expected output

//TEST 2
     // Adding code to expect(). This test should pass
...
//TEST 3
  ...
  var singleUser = {
    ...
    beforeEach(angular.mock.module('api.users'));   //beforeEach is Jasmine function allowing code to run before test
